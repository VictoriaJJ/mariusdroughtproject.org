...
## Further information
## Papers:
o	weather@home 2 description and validation paper currently in review: link to http://www.geosci-model-dev-discuss.net/gmd-2016-239/
## Podcasts:
o	The climate datasets, particularly the drought event set, being generated in the MaRIUS project: https://youtu.be/i4kApYaeQpQ
o	Western US drought attribution, and the generation of synthetic multi-year UK drought events for risk-based impact studies:
